# Local Development
Hyperodactyl is now powered by React, Typescript, and Tailwindcss using webpack at its core to generate compiled assets.
Release versions of Hyperodactyl will include pre-compiled, minified, and hashed assets ready-to-go.
...
The command above will download all of the dependencies necessary to get Hyperodactyl assets building. After that, its as
...
the asset URLs used in Hyperodactyl.

#### Development Environment
If you're using the [`hyperodactyl/development`](https://github.com/hyperodactyl/development) environments, which are
