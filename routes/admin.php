...
use Hyperodactyl\Http\Controllers\Admin;
use Hyperodactyl\Http\Middleware\Admin\Servers\ServerInstalled;
...
Route::group(['prefix' => 'settings'], function () {
    ...
    Route::post('/branding/logo', [Admin\Settings\BrandingController::class, 'uploadLogo'])->name('admin.settings.branding.logo');
    Route::post('/branding/favicon', [Admin\Settings\BrandingController::class, 'uploadFavicon'])->name('admin.settings.branding.favicon');

    Route::patch('/branding', [Admin\Settings\BrandingController::class, 'update'])->name('admin.settings.branding.update');
...
|--------------------------------------------------------------------------
|
| Endpoint: /admin/hyper
|
*/
Route::group(['prefix' => 'hyper'], function () {
    Route::get('/', [Admin\Hyper\HyperEconomyController::class, 'index'])->name('admin.hyper.index');
    Route::post('/users/{user:id}/adjust', [Admin\Hyper\HyperEconomyController::class, 'adjustBalance'])->name('admin.hyper.adjust');

    Route::get('/store', [Admin\Hyper\HyperEconomyController::class, 'store'])->name('admin.hyper.store');
    Route::post('/store', [Admin\Hyper\HyperEconomyController::class, 'storeCreate']);
    Route::patch('/store/{item:id}', [Admin\Hyper\HyperEconomyController::class, 'storeUpdate']);

    Route::get('/achievements', [Admin\Hyper\HyperEconomyController::class, 'achievements'])->name('admin.hyper.achievements');
    Route::post('/achievements', [Admin\Hyper\HyperEconomyController::class, 'achievementCreate']);
    Route::patch('/achievements/{achievement:id}', [Admin\Hyper\HyperEconomyController::class, 'achievementUpdate']);
});

/*
|--------------------------------------------------------------------------
| LXC Node & Container Controller Routes
|--------------------------------------------------------------------------
|
| Endpoint: /admin/lxc
|
...
Route::group(['prefix' => 'lxc/nodes'], function () {
    Route::get('/', [Admin\Lxc\LxcNodeController::class, 'index'])->name('admin.lxc.nodes');
    Route::get('/new', [Admin\Lxc\LxcNodeController::class, 'create'])->name('admin.lxc.nodes.new');
    Route::get('/view/{node:id}', [Admin\Lxc\LxcNodeController::class, 'view'])->name('admin.lxc.nodes.view');

    Route::post('/new', [Admin\Lxc\LxcNodeController::class, 'store']);

    Route::patch('/view/{node:id}', [Admin\Lxc\LxcNodeController::class, 'update']);

    Route::delete('/view/{node:id}', [Admin\Lxc\LxcNodeController::class, 'delete']);
});

Route::group(['prefix' => 'lxc/containers'], function () {
    Route::get('/', [Admin\Lxc\LxcContainerController::class, 'index'])->name('admin.lxc.containers');
    Route::get('/new', [Admin\Lxc\LxcContainerController::class, 'create'])->name('admin.lxc.containers.new');
    Route::get('/view/{container:id}', [Admin\Lxc\LxcContainerController::class, 'view'])->name('admin.lxc.containers.view');

    Route::post('/new', [Admin\Lxc\LxcContainerController::class, 'store']);
    Route::post('/view/{container:id}/power', [Admin\Lxc\LxcContainerController::class, 'power'])->name('admin.lxc.containers.power');
    Route::post('/view/{container:id}/reassign', [Admin\Lxc\LxcContainerController::class, 'reassign'])->name('admin.lxc.containers.reassign');

    Route::patch('/view/{container:id}', [Admin\Lxc\LxcContainerController::class, 'update']);

    Route::delete('/view/{container:id}', [Admin\Lxc\LxcContainerController::class, 'delete']);
});
