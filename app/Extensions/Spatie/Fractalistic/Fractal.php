...
namespace Hyperodactyl\Extensions\Spatie\Fractalistic;
...
use Hyperodactyl\Extensions\League\Fractal\Serializers\HyperodactylSerializer;
...
class Fractal extends SpatieFractal
{
    ...
    public function createData(): Scope
    {
        ...
        if (is_null($this->serializer)) {
            $this->serializer = new HyperodactylSerializer();
        }
