...
use Hyperodactyl\Contracts\Models\Identifiable;
use Illuminate\Database\Eloquent\Relations\HasOne;
use Illuminate\Database\Eloquent\Relations\HasMany;
use Hyperodactyl\Models\Traits\HasRealtimeIdentifier;
use Illuminate\Database\Eloquent\Relations\BelongsTo;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Eloquent\Relations\MorphToMany;
use Illuminate\Database\Eloquent\Relations\HasManyThrough;
use Hyperodactyl\Exceptions\Http\Server\ServerStateConflictException;

/**
 * \Hyperodactyl\Models\Server.
 *
 * @property int $id
 ...
 * @property \Illuminate\Database\Eloquent\Collection|\Hyperodactyl\Models\ActivityLog[] $activity
 * @property int|null $activity_count
 * @property Allocation|null $allocation
 * @property \Illuminate\Database\Eloquent\Collection|\Hyperodactyl\Models\Allocation[] $allocations
 * @property int|null $allocations_count
 * @property \Illuminate\Database\Eloquent\Collection|\Hyperodactyl\Models\Backup[] $backups
 * @property int|null $backups_count
 * @property \Illuminate\Database\Eloquent\Collection|\Hyperodactyl\Models\Database[] $databases
 * @property int|null $databases_count
 * @property Egg|null $egg
 * @property \Illuminate\Database\Eloquent\Collection|\Hyperodactyl\Models\Mount[] $mounts
 * @property int|null $mounts_count
 * @property Nest $nest
 * @property Node $node
 * @property \Illuminate\Notifications\DatabaseNotificationCollection|\Illuminate\Notifications\DatabaseNotification[] $notifications
 * @property int|null $notifications_count
 * @property \Illuminate\Database\Eloquent\Collection|\Hyperodactyl\Models\Schedule[] $schedules
 * @property int|null $schedules_count
 * @property \Illuminate\Database\Eloquent\Collection|\Hyperodactyl\Models\Subuser[] $subusers
 * @property int|null $subusers_count
 * @property ServerTransfer|null $transfer
 * @property User $user
 * @property \Illuminate\Database\Eloquent\Collection|\Hyperodactyl\Models\EggVariable[] $variables
...
class Server extends Model implements Identifiable
{
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\Hyperodactyl\Models\User, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Hyperodactyl\Models\Subuser, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\Hyperodactyl\Models\Allocation, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Hyperodactyl\Models\Allocation, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\Hyperodactyl\Models\Nest, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\Hyperodactyl\Models\Egg, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Hyperodactyl\Models\EggVariable, $this>
     */
    public function variables(): HasMany
    {
        return $this->hasMany(EggVariable::class, 'egg_id', 'egg_id')
            ...
            ->leftJoin('server_variables', function (JoinClause $join) {
                ...
                //
                // @see https://github.com/hyperodactyl/panel/issues/2250
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\Hyperodactyl\Models\Node, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Hyperodactyl\Models\Schedule, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Hyperodactyl\Models\Database, $this>
     */
     ...
     *
     * @return \Znck\Eloquent\Relations\BelongsToThrough<\Hyperodactyl\Models\Location, \Hyperodactyl\Models\Node>
     *
     * @throws \Exception
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\Hyperodactyl\Models\ServerTransfer, $this>
     */
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Hyperodactyl\Models\Backup, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasManyThrough<\Hyperodactyl\Models\Mount, \Hyperodactyl\Models\MountServer, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\MorphToMany<\Hyperodactyl\Models\ActivityLog, $this>
     */
