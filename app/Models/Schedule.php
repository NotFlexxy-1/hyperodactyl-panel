 ...
 * @property \Illuminate\Database\Eloquent\Collection<int, \Hyperodactyl\Models\Task> $tasks
 */
class Schedule extends Model
{
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Hyperodactyl\Models\Task, $this>
     */
