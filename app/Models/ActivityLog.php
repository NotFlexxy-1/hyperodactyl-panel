...
use Hyperodactyl\Events\ActivityLogged;
...
/**
 * \Hyperodactyl\Models\ActivityLog.
 *
 * @property int $id
 ...
 * @property \Illuminate\Database\Eloquent\Collection<int, \Hyperodactyl\Models\ActivityLogSubject> $subjects
...
class ActivityLog extends Model implements Identifiable
{
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Hyperodactyl\Models\ActivityLogSubject, $this>
     */
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\Hyperodactyl\Models\ApiKey, $this>
     */
