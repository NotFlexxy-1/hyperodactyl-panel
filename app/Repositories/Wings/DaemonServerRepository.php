...
namespace Hyperodactyl\Repositories\Wings;
...
/**
 * @method \Hyperodactyl\Repositories\Wings\DaemonServerRepository setNode(\Hyperodactyl\Models\Node $node)
 * @method \Hyperodactyl\Repositories\Wings\DaemonServerRepository setServer(\Hyperodactyl\Models\Server $server)
 */
class DaemonServerRepository extends DaemonRepository
{
     ...
     *
     * @deprecated
     * @see \Hyperodactyl\Repositories\Wings\DaemonRevocationRepository::deauthorize()
     *
     * @throws DaemonConnectionException
     */
