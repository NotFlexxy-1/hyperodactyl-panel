...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'hyperodactyl:guzzle:timeout',
        'hyperodactyl:guzzle:connect_timeout',
        'hyperodactyl:console:count',
        'hyperodactyl:console:frequency',
        'hyperodactyl:auth:2fa_required',
        'hyperodactyl:client_features:allocations:enabled',
