...
namespace Hyperodactyl\Exceptions;
...
class Handler extends ExceptionHandler
{
     ...
     */
    private const HYPERODACTYL_RULE_STRING = 'hyperodactyl\_rules\_';
    ...
    public function render($request, \Throwable $e): Response
    {
        ...
        //
        // @see https://github.com/hyperodactyl/panel/pull/1468
    ...
    public function invalidJson($request, ValidationException $exception): JsonResponse
    {
        ...
        $errors = Collection::make($exception->errors())->map(function ($errors, $field) use ($codes, $exception) {
            ...
            foreach ($errors as $key => $error) {
                $meta = [
                    'source_field' => $field,
                    'rule' => str_replace(self::HYPERODACTYL_RULE_STRING, 'p_', Arr::get(
                        $codes,
