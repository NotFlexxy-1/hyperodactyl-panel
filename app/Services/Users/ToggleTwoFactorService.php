...
use Hyperodactyl\Repositories\Eloquent\RecoveryTokenRepository;
use Hyperodactyl\Exceptions\Service\User\TwoFactorAuthenticationTokenInvalid;
...
class ToggleTwoFactorService
{
    ...
    public function handle(User $user, string $token, ?bool $toggleState = null): array
    {
        ...
        $isValidToken = $this->google2FA->verifyKey($secret, $token, config()->get('hyperodactyl.auth.2fa.window'));
