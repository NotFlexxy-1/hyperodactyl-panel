...
namespace Hyperodactyl\Services\Allocations;
...
class FindAssignableAllocationService
{
    ...
    {
        if (!config('hyperodactyl.client_features.allocations.enabled')) {
    ...
    {
        $start = config('hyperodactyl.client_features.allocations.range_start', null);
        $end = config('hyperodactyl.client_features.allocations.range_end', null);
