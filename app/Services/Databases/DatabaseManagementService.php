...
use Hyperodactyl\Extensions\DynamicDatabaseConnection;
use Hyperodactyl\Repositories\Eloquent\DatabaseRepository;
use Hyperodactyl\Exceptions\Repository\DuplicateDatabaseNameException;
use Hyperodactyl\Exceptions\Service\Database\TooManyDatabasesException;
use Hyperodactyl\Exceptions\Service\Database\DatabaseClientFeatureNotEnabledException;
...
class DatabaseManagementService
{
     ...
     *
     * @see \Hyperodactyl\Services\Databases\DatabaseManagementService::generateUniqueDatabaseName()
     */
    ...
    {
        if (!config('hyperodactyl.client_features.databases.enabled')) {
        ...
        try {
            ...
            try {
                ...
                // itself isn't able to be created in Hyperodactyl's database.
                //
