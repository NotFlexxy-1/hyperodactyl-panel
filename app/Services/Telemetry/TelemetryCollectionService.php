...
namespace Hyperodactyl\Services\Telemetry;
...
class TelemetryCollectionService
{
    ...
    /**
     * Collects telemetry data and sends it to the Hyperodactyl Telemetry Service.
     */
    public function __invoke(): void
    {
        ...
        Http::post('https://telemetry.hyperodactyl.io', $data);
    }
