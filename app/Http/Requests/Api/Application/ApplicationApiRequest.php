...
namespace Hyperodactyl\Http\Requests\Api\Application;
...
abstract class ApplicationApiRequest extends FormRequest
{
     ...
     *
     * @throws HyperodactylException
     */
    public function authorize(): bool
    {
        if (is_null($this->resource)) {
            throw new HyperodactylException('An ACL resource must be defined on API requests.');
        }
