...
namespace Hyperodactyl\Http\Controllers\Auth;
...
use Hyperodactyl\Events\User\PasswordChanged;
use Hyperodactyl\Exceptions\DisplayException;
use Hyperodactyl\Http\Controllers\Controller;
use Illuminate\Foundation\Auth\ResetsPasswords;
use Hyperodactyl\Http\Requests\Auth\ResetPasswordRequest;
...
class ResetPasswordController extends Controller
{
     ...
     *
     * @param \Illuminate\Contracts\Auth\CanResetPassword&\Hyperodactyl\Models\User $user
