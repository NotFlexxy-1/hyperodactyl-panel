...
use Hyperodactyl\Services\Eggs\EggConfigurationService;
use Hyperodactyl\Exceptions\Http\HttpForbiddenException;
use Hyperodactyl\Repositories\Eloquent\ServerRepository;
use Hyperodactyl\Http\Resources\Wings\ServerConfigurationCollection;
    ...
    public function resetState(Request $request): JsonResponse
    {
        ...
        $this->connection->transaction(function () use ($node, $servers) {
            ...
            foreach ($servers as $server) {
                /** @var \Hyperodactyl\Models\ActivityLog|null $activity */
