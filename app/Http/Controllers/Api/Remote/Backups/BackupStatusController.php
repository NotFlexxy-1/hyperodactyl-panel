...
namespace Hyperodactyl\Http\Controllers\Api\Remote\Backups;
...
use Hyperodactyl\Extensions\Backups\BackupManager;
use Hyperodactyl\Extensions\Filesystem\S3Filesystem;
use Hyperodactyl\Exceptions\Http\HttpForbiddenException;
use Symfony\Component\HttpKernel\Exception\BadRequestHttpException;
use Hyperodactyl\Http\Requests\Api\Remote\ReportBackupCompleteRequest;
...
class BackupStatusController extends Controller
{
    ...
    public function index(ReportBackupCompleteRequest $request, string $backup): JsonResponse
    {
        ...
        /** @var \Hyperodactyl\Models\Node $node */
