...
use Hyperodactyl\Models\Schedule;
use Illuminate\Http\JsonResponse;
use Hyperodactyl\Facades\Activity;
use Hyperodactyl\Helpers\Utilities;
use Hyperodactyl\Exceptions\DisplayException;
use Hyperodactyl\Repositories\Eloquent\ScheduleRepository;
use Hyperodactyl\Services\Schedules\ProcessScheduleService;
use Hyperodactyl\Transformers\Api\Client\ScheduleTransformer;
use Hyperodactyl\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Hyperodactyl\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use Hyperodactyl\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use Hyperodactyl\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use Hyperodactyl\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use Hyperodactyl\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    public function update(UpdateScheduleRequest $request, Server $server, Schedule $schedule): array
    {
        ...
        //
        // @see https://github.com/hyperodactyl/panel/issues/2425
     ...
     *
     * @see https://github.com/hyperodactyl/panel/issues/5671
     *
     * @throws \Throwable
     */
