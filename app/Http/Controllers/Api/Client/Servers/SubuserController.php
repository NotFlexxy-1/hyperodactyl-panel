...
use Hyperodactyl\Jobs\RevokeSftpAccessJob;
use Hyperodactyl\Repositories\Eloquent\SubuserRepository;
use Hyperodactyl\Services\Subusers\SubuserCreationService;
use Hyperodactyl\Transformers\Api\Client\SubuserTransformer;
use Hyperodactyl\Repositories\Wings\DaemonRevocationRepository;
use Hyperodactyl\Http\Controllers\Api\Client\ClientApiController;
use Hyperodactyl\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use Hyperodactyl\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use Hyperodactyl\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use Hyperodactyl\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
     ...
     * @throws \Hyperodactyl\Exceptions\Service\Subuser\ServerSubuserExistsException
     * @throws \Hyperodactyl\Exceptions\Service\Subuser\UserIsServerOwnerException
     * @throws \Throwable
     */
    ...
    {
        /** @var \Hyperodactyl\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
