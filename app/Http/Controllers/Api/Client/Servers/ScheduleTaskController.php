...
use Hyperodactyl\Transformers\Api\Client\TaskTransformer;
...
use Hyperodactyl\Exceptions\Service\ServiceLimitExceededException;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Hyperodactyl\Http\Requests\Api\Client\Servers\Schedules\StoreTaskRequest;
...
class ScheduleTaskController extends ClientApiController
{
    ...
    {
        $limit = config('hyperodactyl.client_features.schedules.per_schedule_task_limit', 10);
