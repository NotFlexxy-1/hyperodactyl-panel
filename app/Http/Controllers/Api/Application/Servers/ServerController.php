...
use Hyperodactyl\Services\Servers\ServerCreationService;
use Hyperodactyl\Services\Servers\ServerDeletionService;
use Hyperodactyl\Transformers\Api\Application\ServerTransformer;
use Hyperodactyl\Http\Requests\Api\Application\Servers\GetServerRequest;
use Hyperodactyl\Http\Requests\Api\Application\Servers\GetServersRequest;
use Hyperodactyl\Http\Requests\Api\Application\Servers\ServerWriteRequest;
use Hyperodactyl\Http\Requests\Api\Application\Servers\StoreServerRequest;
...
class ServerController extends ApplicationApiController
{
     ...
     * @throws \Hyperodactyl\Exceptions\Service\Deployment\NoViableAllocationException
     * @throws \Hyperodactyl\Exceptions\Service\Deployment\NoViableNodeException
     */
