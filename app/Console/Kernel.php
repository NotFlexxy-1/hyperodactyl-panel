...
namespace Hyperodactyl\Console;

use Ramsey\Uuid\Uuid;
use Hyperodactyl\Models\ActivityLog;
use Illuminate\Console\Scheduling\Schedule;
use Illuminate\Database\Console\PruneCommand;
use Hyperodactyl\Repositories\Eloquent\SettingsRepository;
use Illuminate\Foundation\Console\Kernel as ConsoleKernel;
use Hyperodactyl\Services\Telemetry\TelemetryCollectionService;
use Hyperodactyl\Console\Commands\Schedule\ProcessRunnableCommand;
use Hyperodactyl\Console\Commands\Maintenance\PruneOrphanedBackupsCommand;
use Hyperodactyl\Console\Commands\Maintenance\CleanServiceBackupFilesCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        if (config('hyperodactyl.telemetry.enabled')) {
