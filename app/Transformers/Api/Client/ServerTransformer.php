...
class ServerTransformer extends BaseClientTransformer
{
    ...
    public function transform(Server $server): array
    {
        ...
        return [
            ...
            'identifier' => config('hyperodactyl.features.new_server_identifiers')
                ? $server->identifier
                : $server->uuidShort,
            '__deprecated_uuid_short' => $server->uuidShort,
            // In Hyperodactyl 2.0 we'll be replacing `identifier` above with the actual
     ...
     *
     * @throws \Hyperodactyl\Exceptions\Transformer\InvalidTransformerLevelException
     */
