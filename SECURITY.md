...
Hyperodactyl only provides security support for the latest `major.minor` versions of the Panel and Wings software.
...
or send an email to `security@hyperodactyl.io` with the details of your report.
