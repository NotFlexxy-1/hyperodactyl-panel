...
namespace Hyperodactyl\Tests\Traits\Integration;
...
trait CreatesTestModels
{
     ...
     *
     * @return array{\Hyperodactyl\Models\User, \Hyperodactyl\Models\Server}
     */
    ...
    {
        /** @var Egg $egg */
        $egg = Egg::query()->where('author', 'support@hyperodactyl.io')->where('name', 'Bungeecord')->firstOrFail();
