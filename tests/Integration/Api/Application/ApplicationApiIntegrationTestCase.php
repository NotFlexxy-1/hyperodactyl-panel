...
namespace Hyperodactyl\Tests\Integration\Api\Application;
...
use Hyperodactyl\Tests\Traits\Integration\CreatesTestModels;
use Hyperodactyl\Transformers\Api\Application\BaseTransformer;
use Hyperodactyl\Transformers\Api\Client\BaseClientTransformer;
use Hyperodactyl\Tests\Traits\Http\IntegrationJsonRequestAssertions;
...
abstract class ApplicationApiIntegrationTestCase extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this
            ->withHeader('Accept', 'application/vnd.hyperodactyl.v1+json')
