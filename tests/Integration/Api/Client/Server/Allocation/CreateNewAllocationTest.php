...
namespace Hyperodactyl\Tests\Integration\Api\Client\Server\Allocation;
...
class CreateNewAllocationTest extends ClientApiIntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('hyperodactyl.client_features.allocations.range_end', 5050);
    }
    ...
    {
        /** @var \Hyperodactyl\Models\Server $server */
