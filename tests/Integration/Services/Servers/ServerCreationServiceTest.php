...
namespace Hyperodactyl\Tests\Integration\Services\Servers;
...
class ServerCreationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->bungeecord = Egg::query()
            ->where('author', 'support@hyperodactyl.io')
    ...
    public function testServerIsCreatedWithDeploymentObject()
    {
        ...
        /** @var \Hyperodactyl\Models\Allocation[]|\Illuminate\Database\Eloquent\Collection $allocations */
