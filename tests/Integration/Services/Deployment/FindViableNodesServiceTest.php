...
namespace Hyperodactyl\Tests\Integration\Services\Deployment;
...
use Hyperodactyl\Exceptions\Service\Deployment\NoViableNodeException;
...
class FindViableNodesServiceTest extends IntegrationTestCase
{
     ...
     *
     * @see https://github.com/hyperodactyl/panel/issues/2529
     */
    ...
    {
        /** @var \Hyperodactyl\Models\Location[] $locations */
        $locations = Location::factory()->times(2)->create();

        /** @var \Hyperodactyl\Models\Node[] $nodes */
        $nodes = [
