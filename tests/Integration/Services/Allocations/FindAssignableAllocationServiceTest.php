...
namespace Hyperodactyl\Tests\Integration\Services\Allocations;

use Hyperodactyl\Models\Allocation;
use Hyperodactyl\Tests\Integration\IntegrationTestCase;
use Hyperodactyl\Services\Allocations\FindAssignableAllocationService;
use Hyperodactyl\Exceptions\Service\Allocation\AutoAllocationNotEnabledException;
use Hyperodactyl\Exceptions\Service\Allocation\NoAutoAllocationSpaceAvailableException;
...
class FindAssignableAllocationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('hyperodactyl.client_features.allocations.enabled', true);
        config()->set('hyperodactyl.client_features.allocations.range_start', 0);
        config()->set('hyperodactyl.client_features.allocations.range_end', 0);
    }
    ...
    {
        $server = $this->createServerModel();
        config()->set('hyperodactyl.client_features.allocations.range_start', 5000);
        config()->set('hyperodactyl.client_features.allocations.range_end', 5005);
    ...
    public function testOnlyPortNotInUseIsCreated()
    {
        ...
        config()->set('hyperodactyl.client_features.allocations.range_start', 5000);
        config()->set('hyperodactyl.client_features.allocations.range_end', 5001);
    ...
    {
        $server = $this->createServerModel();
        config()->set('hyperodactyl.client_features.allocations.range_start', 'hodor');
        config()->set('hyperodactyl.client_features.allocations.range_end', 10);
        ...
        config()->set('hyperodactyl.client_features.allocations.range_start', 10);
        config()->set('hyperodactyl.client_features.allocations.range_end', 'hodor');
    ...
    {
        config()->set('hyperodactyl.client_features.allocations.enabled', false);
        $server = $this->createServerModel();
