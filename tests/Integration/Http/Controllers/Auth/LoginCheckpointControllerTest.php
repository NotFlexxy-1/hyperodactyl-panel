...
namespace Hyperodactyl\Tests\Integration\Http\Controllers\Auth;
...
use Hyperodactyl\Events\Auth\DirectLogin;
...
class LoginCheckpointControllerTest extends HttpTestCase
{
     ...
     * column value.
     *
     * @see https://github.com/hyperodactyl/panel/security/advisories/GHSA-rgmp-4873-r683
     */
    #[TestWith([1])]
    #[TestWith([30])]
    #[TestWith([80])]
