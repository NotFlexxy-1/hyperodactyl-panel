...
use Hyperodactyl\Contracts\Repository\DaemonKeyRepositoryInterface;
    ...
    public function up(): void
    {
        ...
        $subusers->each(function ($subuser) use (&$inserts) {
            $inserts[] = [
                ...
                'expires_at' => Carbon::now()->addMinutes(config('hyperodactyl.api.key_expire_time', 720))->toDateTimeString(),
