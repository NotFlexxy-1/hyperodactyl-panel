...
module.exports = {
    ...
    devServer: {
        ...
        server: {
            ...
            options: process.env.USE_LOCAL_CERTS
                ? {
                      ...
                      cert: path.join(__dirname, '../../docker/certificates/hyperodactyl.test.pem'),
                      key: path.join(__dirname, '../../docker/certificates/hyperodactyl.test-key.pem'),
                  }
                : undefined,
        },
        static: {
        ...
        allowedHosts: ['.hyperodactyl.test'],
        headers: {
