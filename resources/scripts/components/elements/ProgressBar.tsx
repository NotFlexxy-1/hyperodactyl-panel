...
const BarFill = styled.div`
    ${tw`h-full`};
    background-image: linear-gradient(90deg, rgb(var(--hyper-brand)), rgb(var(--hyper-accent)));
    transition: 250ms ease-in-out;
    box-shadow: 0 0 12px 1px rgb(var(--hyper-brand) / 0.6);
`;
...
export default () => {
    ...
    return (
        <div css={tw`w-full fixed z-50 top-0 left-0`} style={{ height: '2px' }}>
