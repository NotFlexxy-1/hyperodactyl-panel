...
@section('content-header')
    <h1>Advanced Settings<small>Configure advanced settings for Hyperodactyl.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="hyperodactyl:guzzle:connect_timeout" value="{{ old('hyperodactyl:guzzle:connect_timeout', config('hyperodactyl.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="hyperodactyl:guzzle:timeout" value="{{ old('hyperodactyl:guzzle:timeout', config('hyperodactyl.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Status</label>
                                <div>
                                    <select class="form-control" name="hyperodactyl:client_features:allocations:enabled">
                                        <option value="false">Disabled</option>
                                        <option value="true" @if(old('hyperodactyl:client_features:allocations:enabled', config('hyperodactyl.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                    </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="hyperodactyl:client_features:allocations:range_start" value="{{ old('hyperodactyl:client_features:allocations:range_start', config('hyperodactyl.client_features.allocations.range_start')) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="hyperodactyl:client_features:allocations:range_end" value="{{ old('hyperodactyl:client_features:allocations:range_end', config('hyperodactyl.client_features.allocations.range_end')) }}">
