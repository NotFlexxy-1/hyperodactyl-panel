...
return [
    ...
    */
    ...
    | standard Hyperodactyl shipped services.
    */
    ...
    */
    ...
    'cdn' => [
        'cache_time' => 60,
        'url' => 'https://cdn.hyperodactyl.io/releases/latest.json',
    ],
    ...
    */
    ...
    'client_features' => [
        'databases' => [
            'enabled' => env('HYPERODACTYL_CLIENT_DATABASES_ENABLED', true),
            'allow_random' => env('HYPERODACTYL_CLIENT_DATABASES_ALLOW_RANDOM', true),
        ],

        'schedules' => [
            // The total number of tasks that can exist for any given schedule at once.
            'per_schedule_task_limit' => env('HYPERODACTYL_PER_SCHEDULE_TASK_LIMIT', 10),
        ],

        'allocations' => [
            'enabled' => env('HYPERODACTYL_CLIENT_ALLOCATIONS_ENABLED', false),
            'range_start' => env('HYPERODACTYL_CLIENT_ALLOCATIONS_RANGE_START'),
            'range_end' => env('HYPERODACTYL_CLIENT_ALLOCATIONS_RANGE_END'),
        ],
    ],
    ...
    */
    ...
    'files' => [
        'max_edit_size' => env('HYPERODACTYL_FILES_MAX_EDIT_SIZE', 1024 * 1024 * 4),
    ],
    ...
    */
    ...
    'assets' => [
        'use_hash' => env('HYPERODACTYL_USE_ASSET_HASH', false),
    ],
    ...
    */
    ...
    'email' => [
        ...
        'send_install_notification' => env('HYPERODACTYL_SEND_INSTALL_NOTIFICATION', true),
        // Should an email be sent to a server owner whenever their server is reinstalled?
        'send_reinstall_notification' => env('HYPERODACTYL_SEND_REINSTALL_NOTIFICATION', true),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | This section controls the telemetry sent by Hyperodactyl.
    */

    'telemetry' => [
        'enabled' => env('HYPERODACTYL_TELEMETRY_ENABLED', true),
    ],

    'features' => [
        'new_server_identifiers' => (bool) env('HYPERODACTYL_USE_SERVER_IDENTIFIERS', false),
    ],
];
